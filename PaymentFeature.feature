Feature: Validating Payments scenarios-Sign in at checkout, verify contact Information displayed, confirm order placement with Visa
...
And user validate checkout screen in DSG application And user tap on ContinueToPayment button In DSG application
